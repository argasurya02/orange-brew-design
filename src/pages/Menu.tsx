...
const Menu = () => {
  ...
  return (
    <div className="container mx-auto pb-24 px-4 pt-6">
      ...
      {/* Search & Filter */}
      <div className="mb-6 mt-6 space-y-4 sticky top-[64px] z-30 bg-background/95 backdrop-blur py-4 px-4 rounded-2xl">
        ...
        <div className="flex gap-2 overflow-x-auto pb-2 scrollbar-hide">
          {categories.map((cat) => (
            <Badge
              ...
              className={`px-6 py-2 rounded-full cursor-pointer whitespace-nowrap transition-all ${filter === cat
